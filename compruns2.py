...
filefolder = ["/FTH200Y_closesr90_R1/", "/FTH200Y_closesr90_R6/", "/FTH200Y_closesr90_R7/", "/FTH200Y_closesr90_R8/", "/FTH200Y_closesr90_R9/"]
prefix = ["FTH200Y_closesr90_R1", "FTH200Y_closesr90_R6", "FTH200Y_closesr90_R7_b", "FTH200Y_7_closesr90_LTR_R8", "FTH200Y_closesr90_R9"]
desc = ["R12","R7", "R6", "R5", "R4"]
pitch = [70, 80, 240, 120, 70]
...
etagraph.SetTitle("Fraction Events Eta between 0.2-0.8 vs Time;Time (Days);")
...
legend2 = R.TLegend(0.6,0.6,0.89,0.85)
...
for i in xrange(len(filefolder)):
	...
	legend.AddEntry(hmpv, desc[i] + ", " + str(pitch[i]) + " um", "l")
	legend2.AddEntry(hmpv, desc[i] + ", " + str(pitch[i]) + " um", "l")
...
legend.Write("lrlenged")
legend2.Write("urlegend")
RFile.Close()
